...
const UserPageContent = () => {
  ...
  return (
    <div className="container grid lg:grid-cols-6 md:grid-cols-1 mx-auto gap-4 mt-4 px-3">
      <Link to={"/cashIn"} className="bg-[#55AD9B]/50 text-2xl px-3 col-span-2 rounded-lg py-3 flex items-center  cursor-pointer justify-between">
      ...
      <Link to={"/sendMoney"} className="bg-yellow-500/50 text-2xl px-3 col-span-2 cursor-pointer rounded-lg py-3 flex items-center justify-between">
      ...
      <Link to={"/userSelfTransaction"} className="bg-blue-500/50 lg:col-span-3 text-2xl px-3 rounded-lg py-3 flex cursor-pointer items-center justify-between">
      ...
      <Link to={"/pendingTransitions"} className="bg-sky-500/50 lg:col-span-3 text-2xl px-3 rounded-lg py-3 flex cursor-pointer items-center justify-between">
